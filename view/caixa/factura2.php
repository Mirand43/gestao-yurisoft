    ...
    <div class="row invoice-info">
      ...
      <div class="col-sm-4 invoice-col">
        ...
        <address>
          ...
          <strong>Morada:</strong> <?php print ($row['morada']);?><br>
          <strong>Telefone:</strong> <?php print ($row['telefone']);?><br>
          <strong>E-mail:</strong> <?php print ($row['email']);?><br>
        </address>
      </div>
      <!-- /.col -->
      <div class="col-sm-4 invoice-col">
      ...
      <div class="col-xs-12 table-responsive">
        <table class="table table-striped">
          ...
          <tbody>
            ...
            <?php $crud-> VerDetalhesUltimaVenda(); ?>
      ...
      <div class="col-xs-6">
        ...
        <div class="table-responsive">
          <table class="table">
            ...
            <tr>
              <th><strong>Operador:</strong> <?php echo  ($_SESSION['username']);  ?></th>
            </tr>
          </table>
        </div>
      </div>
