      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="Produto.php"><i class="fa fa-circle-o"></i> Ver</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="Add_Fornecedor.php"><i class="fa fa-circle-o"></i> Cadastrar</a></li>
            <li><a href="fornecedor.php"><i class="fa fa-circle-o"></i> Ver</a></li>
          </ul>
        </li>
        <li>
          <a href="cliente.php">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="add_stock.php"><i class="fa fa-circle-o"></i> Adicionar</a></li>
